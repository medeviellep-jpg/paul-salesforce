...
export const productsContext: ProductContext[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "Comment fonctionne le pricing à la résolution ?", reponse: "$2 par résolution réussie = 400 Flex Credits. Si l'agent ne résout pas le problème et escalade vers un humain, la conversation n'est pas facturée comme résolution." },
      ...
      { question: "Faut-il Experience Cloud pour utiliser Help Agent ?", reponse: "Help Agent s'intègre nativement dans les portails Experience Cloud mais peut aussi être déployé sur d'autres canaux web." }
    ],
    convictionsFranceText: "Help Agent c'est le play Time-to-Value immédiat sur le Service. Moins de 10 minutes pour déployer — argument massue face aux projets CRM à 18 mois. Pricing à la résolution ($2/résolution) — on ne paie que ce qui fonctionne, ROI immédiat. Même stack qu'Agentforce Service Agent — porte d'entrée vers un déploiement plus large.",
    ressources: [
